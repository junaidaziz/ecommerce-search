      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link
              href="/"
              className="inline-block cursor-pointer transition-all duration-300 ease-out hover:scale-105 hover:shadow-lg"
            >
              <Image
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-base-content/70">123 Market Street, London, UK</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-primary flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="mailto:info@shopverse.com" className="text-sm text-base-content/70 hover:text-primary transition-colors">
                  info@shopverse.com
                </a>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-base-content/70">+44 1234 567890</span>
              </div>
            </div>

            {/* Social Media */}
            <div className="flex space-x-4">
              <a href="#" className="p-2 bg-primary/10 text-primary rounded-full hover:bg-primary hover:text-primary-content transition-all duration-200 hover:scale-110">
          ...
          <div>
            ...
            <form onSubmit={handleSubmit(submit)} className="space-y-3">
              <div>
                <input
                  ...
                  className="input input-bordered w-full bg-base-100 border-base-300 focus:border-primary focus:ring-1 focus:ring-primary"
                  {...register('email', { 
              ...
              <button
                type="submit"
                className="btn btn-primary w-full transition-all duration-200 hover:scale-105"
              >
            ...
            {/* Payment Methods */}
            <div className="mt-8">
              <h5 className="text-sm font-semibold text-base-content mb-3">We Accept</h5>
              <div className="flex items-center space-x-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <Link href="/privacy-policy" className="text-base-content/60 hover:text-primary transition-colors">
                Privacy
              </Link>
              <Link href="/terms-and-conditions" className="text-base-content/60 hover:text-primary transition-colors">
                Terms
              </Link>
              <Link href="/sitemap" className="text-base-content/60 hover:text-primary transition-colors">
                Sitemap
              </Link>
            </div>
          </div>
